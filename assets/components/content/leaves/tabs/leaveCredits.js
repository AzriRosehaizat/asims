...
application.service('leaveCredits', function($http, _, uiGridConstants, formService, gridService) {
    return {
        gridOptions: function($scope) {
            return {
                ...
                onRegisterApi: function(gridApi) {
                    gridService.set(gridApi, 'leaveCredit');
    ...
    function initializeEdit(formData, gridData, row) {
        ...
        formData.title = ('Leave Credit');
        formData.inputs = getInputs();

        formService.init(formData, gridData, row, 'leaveCredits', false);
    }
    ...
    function initializeAdd(formData, gridData, parentRow) {
        ...
        formService.init(formData, gridData, null, 'leaveCredits', false);
    }
    ...
    function getInputs() {
        return [{
            ...
            path: "leaveCreditType",
            text: "Select a Credit Type",
            required: true
        }, {
            type: "textarea",
            name: "description",
